<?php 
    include "server.php";
        ...
        echo 'New name of image2 '.$id_back_new_name.'<br>';
            ...
            $sql = "INSERT INTO professor_table (professor_name, professor_department, professor_username, professor_password, 
            professor_retype_password, professor_address, professor_id_front, professor_id_back)
            VALUES ('$fullname', '$department', '$username', '$enc_password', '$enc_r_password', '$address', 
