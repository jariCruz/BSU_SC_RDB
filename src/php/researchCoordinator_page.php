...
<div class="container-fluid">
  ...
  <ul class="nav nav-tabs">
    <li class="nav-item">
      <a class="nav-link" href="#overview" onclick="removeActive()">Overview</a>
    </li>
    <li class="nav-item">
    ...
    <div class="tab-content">
        ...
        <!-- Overview tab -->
        <div id="overview" class="container tab-pane fade"><br>
            <h5>Overview</h5>
        ...
        <!-- Student tab -->
        <div id="student" class="container-fluid tab-pane fade active show"><br>
...
-->
        ...
        <!-- Professor tab -->
        <div id="professor" class="container tab-pane fade"><br>
            <h5>Professor</h5>
            <p>This is where professor account list can be seen</p>
