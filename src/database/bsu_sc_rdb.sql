...
INSERT INTO `researchstudy_table` (`RS_ID`, `Title`, `Abstract`, `Author`, `File`, `Year`, `Course`, `Keywords`, `Adviser`) VALUES
(35, 'how to train ur junior', 'basta abstract to', 'Jari Cruz', 'how_to_train_ur_junior.pdf.pdf', '4th year', 'educ', 'junior,how to,train', 'Ms. Satan'),
(36, 'Me, Myself and I', 'abstract to', 'Chimpay Sy', 'Me,_Myself_and_I.pdf', '4th year', 'bsit', 'myself,satan', 'Mr. Satan');
...
--
ALTER TABLE `researchstudy_table`
  MODIFY `RS_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
('root', '[{\"db\":\"bsusc_research_databank\",\"table\":\"researchstudy_table\"},{\"db\":\"bsusc_research_databank\",\"table\":\"student_table\"},{\"db\":\"test\",\"table\":\"test_add\"},{\"db\":\"bsusc_research_databank\",\"table\":\"test_search\"}]');
...
('root', '2020-12-30 11:12:27', '{\"Console\\/Mode\":\"collapse\"}');
...
INSERT INTO `test_add` (`id`, `fname`, `lname`) VALUES
(1, 'jari', 'cruz'),
(2, 'iraj', 'cruz');
